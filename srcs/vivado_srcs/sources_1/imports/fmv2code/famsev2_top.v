...
(* DONT_TOUCH = "YES" *)    ila_famse_top i_ila_famse_top(
        .clk(       mig_clk),
        .probe0(   mig_rddata_en),
        .probe1(   mig_rddata),       //  512 bit
        .probe2(   mcRdCAS), 
        .probe3(   mcWrCAS), 
        .probe4(   mig_wrdata_en),
        .probe5(   mig_wrdata_mask),  //  64 bit
        .probe6(   mig_wrdata),       //  512 bit
        .probe7(   winInjTxn),
        .probe8(   gt_data_ready),
        .probe9(   per_rd_done),
        ...
        .probe22(   debug_sta_rst),
        .probe23(   debug_sta_idl), 
        .probe24(   debug_act_cmd),
        .probe25(   debug_act_wat),
        ...
        .probe44(   rddata_ignore),
        .probe45(   rddata_en_and_no_VTT)
    );
    
(* DONT_TOUCH = "YES" *)    ila_dfi_top i_ila_dfi_top (
       .clk   (         dfi_clk                  ),
       .probe0(         dfi_rddata_en            ),
       .probe1(         dfi_rddata_valid         ),
       .probe2(         dfi_rddata               ),   //  256 bit
       .probe3(         dfi_wrdata_en            ),
       .probe4(         dfi_wrdata_mask          ),   //  32 bit
       .probe5(         dfi_wrdata               ),   //  256 bit
       .probe6(         RD_CMD                   ),
       .probe7(         WR_CMD                   ),
       .probe8(         ACT_CMD                  )
    );
